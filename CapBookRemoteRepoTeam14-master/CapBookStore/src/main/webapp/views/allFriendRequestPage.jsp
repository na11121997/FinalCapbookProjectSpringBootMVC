					...
					<div class="w3-col m12">
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								<h6 class="w3-opacity">Friend Requests</h6>
                                <s:forEach var="abc" items="${allfriendRequests}">
											${abc.senderEmailId}		
				                		<form action="getFriendProfile" method="post">
					                          <input type="hidden" name="friendProfileId" value="${abc.senderEmailId}">
               							...
               							<form action="acceptFriendRequest" method="post">
					                          <input type="hidden" name="senderId" value="${abc.senderEmailId}">
												<button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="material-icons"></i>ACCEPT
											</button>
               							</form>
               							<form action="rejectFriendRequest" method="post">
					                          <input type="hidden" name="senderId" value="${abc.senderEmailId}">
												<button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="material-icons"></i>REJECT
											</button>
               							</form>
									</s:forEach>
