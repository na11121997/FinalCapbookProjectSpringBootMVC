...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><h3>EDIT PROFILE</h3><br>
      					<div class="w3-container w3-card w3-white w3-round w3-margin"><h4>EDIT PROFILE PICTURE</h4><br><br>
                        <img src="${account.profileImage}"  class="avatar img-circle img-thumbnail" alt="avatar" width=350px height=250px>
							<form action="savefile" method="post"
								enctype="multipart/form-data">
								<input type="file" name="file" /><br> <br><input type="submit"
									value="Upload Profile Picture" /><br>
							</form><br></div>
        	      <div class="w3-container w3-card w3-white w3-round w3-margin"><h4>EDIT PRIVATE INFORMATION</h4><br><br>
                  <form action="updateInfoFirstName" method="post">
              
				First Name &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="text"
				name="firstName" id="name" placeholder="${account.firstName}" /><input
								type="submit" value="Update" />
						</form><br>
                        
                        <form action="updateInfoLastName" method="post">
							Last Name &nbsp;&nbsp; &nbsp; <input type="text"
								name="lastName" id="name" placeholder="${account.lastName}" /><input
								type="submit" value="Update" />
						</form><br>
                        <form action="updateInfoMobileNo" method="post">
							Mobile No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <input type="text"
								name="mobileNo" id="name"
								placeholder="${account.privateInfo.mobileNo}" /><input
								type="submit" value="Update" />
						</form><br>
                        <form action="updateInfoDOB" method="post">
							Date Of Birth&nbsp;&nbsp; <input type="text" name="DOB" id="name"
								placeholder="${account.privateInfo.DOB}" /><input type="submit"
								value="Update" />
								<br>
						</form><br>
		 ...
		 <div class="w3-container w3-card w3-white w3-round w3-margin"><h4>EDIT ADDRESS</h4><br><br><form action="updateInfoCity" method="post">
							City &nbsp;&nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <input type="text" name="city" id="name"
								placeholder="${account.privateInfo.address.city}" /><input
								type="submit" value="Update" />
						</form><br>
                        <form action="updateInfoState" method="post">
							State &nbsp;&nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp;&nbsp; &nbsp;  <input type="text" name="state" id="name"
								placeholder="${account.privateInfo.address.state}" /><input
								type="submit" value="Update" />
						</form><br>
                        <form action="updateInfoCountry" method="post">
							Country&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" name="country" id="name"
								placeholder="${account.privateInfo.address.country}" /><input
								type="submit" value="Update" />
						</form><br>
                        
                        <form action="updateInfoZipCode" method="post">
							Zip Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
								type="text" name="zipCode" id="name"
								placeholder="${account.privateInfo.address.zipCode}" /><input
								type="submit" value="Update" />
								<br>
						</form><br>
                        </div>
