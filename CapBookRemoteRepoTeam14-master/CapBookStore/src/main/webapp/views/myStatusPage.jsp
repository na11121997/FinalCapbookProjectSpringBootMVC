...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><h3>EDIT STATUS</h3><br>
      				
          <div class="w3-row-padding" style="margin:0 -16px">
            		<form action="updateStatus" method="post">
			 <br><br>	&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;My Status<br>
				&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;<textarea name="myStatus" rows="5" cols="30" minlength="10" maxlength="20">${account.myStatus}</textarea>	
