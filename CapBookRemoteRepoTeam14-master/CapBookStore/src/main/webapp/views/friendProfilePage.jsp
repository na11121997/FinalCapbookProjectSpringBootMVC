	...
	<div class="w3-top">
		<div class="w3-bar w3-theme-d2 w3-left-align w3-large">
			<a
				...
				<a href="friendtoUserHome" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"
				title="Home"><i class="fa fa-home w3-margin-right"></i></a> 
				<a href="friendtoUserHomemyStatus"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				title="Status"><i class="fa fa-user"></i></a> 
				<a href="friendtoUserHomecheckMails" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				title="Emails"><i class="fa fa-envelope"></i></a>
			...
			<div align="right" class="w3-dropdown-hover w3-hide-small  left">
				...
				<div class="w3-dropdown-content w3-card-4 w3-bar-block"
					style="width: 300px">
					<a href="editProfile" class="w3-bar-item w3-button">Edit
						Profile</a> <a href="changePassword" class="w3-bar-item w3-button">Change
						Your Password</a> <a href="logout" class="w3-bar-item w3-button">Logout</a>
				</div>
			</div>
 ...
 <div class="topnav">
	...
	<div class="w3-container w3-content"
		...
		<div class="w3-row">
				...
				<div class="a">
					<div class="w3-card w3-round w3-white">
						<div class="w3-container">
							<h4 class="w3-center">${friendaccount.firstName}&nbsp;${friendaccount.lastName}</h4>
							<p class="w3-center">
								<img src="${friendaccount.profileImage}" class="w3-circle"
									style="height: 106px; width: 106px" alt="Avatar">
							</p>
							<hr>
							<p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i>${friendaccount.privateInfo.DOB}</p>
							<p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i>${friendaccount.privateInfo.address.state},${friendaccount.privateInfo.address.country}</p>
							<p> <i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i>${friendaccount.myStatus}</p>
						</div>
					</div>
				</div>
				<br>
					...
					<div class="w3-col m12">
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								<h6 class="w3-opacity">Click to see Friends Posts</h6>
                                		<form action="getFriendsPost" method="post">
					                          <input type="hidden" name="friendProfileId" value="${friendaccount.emailId}">
												<button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom">Friends All Previous Posts
											</button>
               							  </form>
			...
			<s:forEach var="abc" items="${friendposts}">
					<div class="w3-container w3-card w3-white w3-round w3-margin">
						<br> <img src="${friendaccount.profileImage}" alt="Avatar"
                  ...
                  <form action="updateLikesForFriends" method="post">
                          <input type="hidden" name="postId" value="${abc.postId}">
            			 <input type="hidden" name="likedBy" value="${friendaccount.emailId}">
							<button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom">
							<i class="fa fa-thumbs-up"></i>Like ${abc.totalLikeCount}
						</button>
                 </form>
                  <!-- DISLIKEEE -->
                  <form action="updateDislikesForFriends" method="post">
                          <input type="hidden" name="postId" value="${abc.postId}">
            			 <input type="hidden" name="dislikedBy" value="${friendaccount.emailId}">
							<button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom">
