...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><h3>Mail</h3><br>
	
				<h3><a  href="checkMails"><i class="material-icons">arrow_back</i>Back to Inbox</a><br></h3>
				<form action="sendEmailURI" method="post">
		
		
					<label for="email" class="required">To <br></label> <input
						type="email" name="toEmail" id="email" value="" tabindex="2"
						required="required"> <label for="subject" class="required">
						<br>Subject<br></label>
					<textarea name="subject" id="subject" rows="2" tabindex="3"
						required="required"></textarea><br>
		
					<label for="messageBody" class="required"> Compose email</label><br>
					<textarea name="message" id="MessageBody" rows="10" tabindex="4"
						required="required"></textarea><br>
