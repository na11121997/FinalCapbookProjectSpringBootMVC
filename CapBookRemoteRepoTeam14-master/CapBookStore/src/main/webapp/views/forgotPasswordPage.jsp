			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="text-center">
						...
						<h2 class="text-center">Enter your Security Pin</h2>
						<div class="panel-body">

							<form action="forgotPassword1" method="post" onsubmit="return checkForm(this);">
								...
								<div class="form-group">
									<div class="input-group">
										<span class="input-group-addon"><i
                                            ...
                                            <input id="question" name="question" placeholder="Security Pin"
