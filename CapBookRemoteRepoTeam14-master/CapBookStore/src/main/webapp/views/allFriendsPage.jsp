			...
			<div align="right" class="w3-dropdown-hover w3-hide-small  left">
				...
				<div class="w3-dropdown-content w3-card-4 w3-bar-block"
					...
					<a href="editProfile" class="w3-bar-item w3-button">Edit
						...
						Your Password</a> <a href="/" class="w3-bar-item w3-button">Logout</a>
				</div>
			</div>
					...
					<div class="w3-col m12">
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								<h6 class="w3-opacity">Friends </h6>
								<!-- ALL FRIENDS ALL FRIENDS -->
								<!-- ALL FRIENDS ALL FRIENDS -->
                                <s:forEach var="abc" items="${allfriends}">
											${abc.friendEmailId} <br>
										<form action="getFriendProfile" method="post">
					                          <input type="hidden" name="friendProfileId" value="${abc.friendEmailId}">
					                          ...
					                          <input type="hidden" name="friendProfileId" value="${abc.friendEmailId}">
					                          <button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom"></i>Remove Friend
               								</button>
               							</form>-->
