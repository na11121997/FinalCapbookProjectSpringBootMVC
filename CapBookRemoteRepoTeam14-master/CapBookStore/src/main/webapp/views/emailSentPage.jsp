...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="editProfile" class="w3-bar-item w3-button w3-padding-large">My Profile</a>
</div>
...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><h3>Mails Sent</h3><br>
	...
	<table>
		...
		<s:forEach var="abc" items="${emails}">
			<tr align="center">
				<td>
                <form action="viewAMailSent" method="post">
